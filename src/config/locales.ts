...
export const defaultTexts = {
  ...
  statsBar: {
    ...
    trafficTotal: "总配额",
    serverCost: "服务器金额",
    priceSettings: "金额显示设置",
    pricePeriod: "计费周期",
    priceTotal: "总价",
    priceMonthly: "每月",
    priceDaily: "每日",
    priceCurrency: "显示货币",
    priceNormalization: "节点金额统一显示",
    priceNormalize: "跟随计费周期",
    priceNormalizeFollowPeriod: "开启后跟随上方的计费周期",
    nodePriceSettings: "节点金额设置",
    nodePriceFollowCurrency: "节点金额跟随显示货币",
    currencyUsd: "美元 (USD)",
    currencyCny: "人民币 (CNY)",
    currencyRate: "汇率：1 USD ≈ {rate} CNY",
    exchangeRateSettings: "汇率设置",
    exchangeRateAuto: "自动更新汇率",
    exchangeRateUpdating: "正在更新汇率…",
    exchangeRateUpdated: "最近更新：{date}",
    exchangeRateNotUpdated: "尚未获取自动汇率",
    exchangeRateFallback: "更新失败，当前使用缓存汇率",
    exchangeRateRefresh: "立即更新",
    exchangeRateProvider: "来源：Frankfurter 每日参考汇率",
    exchangeRateManual: "手动汇率",
    exchangeRateManualHelp: "格式：USD=7.2,CAD=5.0（1 外币 = 多少人民币）",
